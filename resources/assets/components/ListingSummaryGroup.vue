<template>
	<div class="listing-summary-group">
		...
		<div class="listing-carousel">
			<div class="controls">
				<carousel-control @change-image="change" :style="leftArrowStyle"  dir="left"></carousel-control>
				<carousel-control @change-image="change" :style="rightArrowStyle" dir="right"></carousel-control>
			</div>
